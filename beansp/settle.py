...
def settle(base, z, x_0, mdot, cfac, mass, radius, corr=None):
    """
    ...
    :param mdot: accretion rate as a fraction of Eddington (as defined by
      settle)
    :param cfac: correction factor for fluence and recurrence time
    :param mass: neutron star mass [M_sun]
    :param radius: neutron star radius [km]
    :param corr: correction function to modify the settle output
    ...
    # run settle, returning a 3-element array with alpha, trec [hr], and
